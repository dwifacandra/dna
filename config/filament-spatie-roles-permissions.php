...
return [
    ...
    'navigation_section_group' => 'Authorization',

    'team_model' => false,

    'scope_to_tenant' => true,

    'super_admin_role_name' => 'Adminstrator',
     ...
     */
    'clusters' => [
        'permissions' => \App\Core\Clusters\Settings::class,
        'roles' => \App\Core\Clusters\Settings::class,
    ],
     ...
     */
    'icons' => [
        'role_navigation' => 'core.fill.lock',
        'permission_navigation' => 'core.fill.lock_person',
    ],
