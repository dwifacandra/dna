<footer class="mt-auto bg-neutral-200 core-bg-grid-3">
    <div class="flex flex-col max-w-screen-xl gap-4 px-6 py-8 mx-auto">
        ...
        <div
            class="flex flex-col justify-between pt-6 border-t border-gray-200 md:items-center gap-y-4 md:flex-row dark:border-neutral-700">
            ...
            <div
                class="text-sm text-gray-600 select-all hover:text-gray-800 focus:outline-none focus:text-gray-800 dark:text-neutral-400 dark:hover:text-neutral-200 dark:focus:text-neutral-200">
