<div class="container flex flex-col px-4 mx-auto gap-y-6" id="resume">
        ...
        <div class="flex flex-col gap-4">
            <div class="flex flex-col gap-6 p-6 bg-white rounded-sm shadow-lg hover:shadow-2xl">
                <div class="flex items-center gap-x-3">
                    <div class="shrink-0">
                        <img class="object-contain rounded-full shrink-0 size-16" src="{{ asset('img/whoami.png') }}"
                            alt="Avatar">
                    </div>
                    <div class="grow">
                ...
                <div class="flex flex-col items-start justify-between gap-4">
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                        ...
                        <div class="flex flex-col items-start justify-center text-sm">
                            <h3 class="text-lg font-medium">{{ $skillGroup->name }}</h3>
                            <div class="flex flex-row flex-wrap items-center justify-start gap-1">
                                ...
                                <div
                                    ...
                                    <x-icon name="{{ $skill->icon }}" class="size-8 text-[{{ $skill->icon_color }}]" />
                    ...
                    <button class="w-full hs-accordion-toggle" aria-expanded="{{ $index === 0 ? 'true' : 'false' }}"
                        ...
                        <div class="flex flex-row items-start justify-start gap-4 text-left">
                            ...
                            <div class="flex flex-col items-start justify-center">
                                ...
                                <p class="text-sm font-medium text-balance md:text-pretty line-clamp-2 md:text-base">
                                    {{ $company->description }}
                                </p>
                            </div>
                        </div>
