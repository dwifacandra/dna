<div class="max-w-screen-xl py-8 mx-auto">
    <div data-hs-carousel='{"isDraggable": true,"isAutoPlay": true}' class="relative">
        <div class="flex space-x-4 hs-carousel">
            <div class="flex-none">
                <div
                    class="flex flex-col overflow-y-auto overflow-x-hidden hs-carousel-pagination max-h-[80vh] gap-y-2">
            ...
            <div class="relative overflow-hidden bg-white shadow-lg grow min-h-[80vh] max-w-screen-sm">
                <div
            ...
            <div class="flex flex-col justify-start max-w-screen-sm p-6 bg-white shadow-lg gap-y-4">
                ...
                <div class="flex gap-2">
                    <button type="button" class="px-6 py-2 text-white rounded-sm bg-success hover:bg-opacity-90">
                        Order now
                    </button>
                    <button type="button" class="px-6 py-2 bg-transparent border border-gray-800 rounded-sm">
                        Preview
                    </button>
                </div>
